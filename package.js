...
Package.on_use(function (api) {
  ...
  api.add_files('client/ctrls/host-ctrl-container/host-ctrl-container.html', 'client');
  ...
  api.add_files('client/ctrls/device/device.html', 'client');
  ...
  api.add_files('client/ctrls/host-ctrl-container/host-ctrl-container.coffee', 'client');
  api.add_files('client/ctrls/host-ctrl-container/host-ctrl-container.styl', 'client');
  ...
  api.add_files('client/ctrls/device/device.coffee', 'client');
  api.add_files('client/ctrls/device/device.styl', 'client');
  ...
  api.add_files('client/ui-harness/autorun.coffee', 'client');
  api.add_files('client/ui-harness/config.coffee', 'client');
  api.add_files('client/ui-harness/ctrl-host.coffee', 'client');
  api.add_files('client/ui-harness/helper-delay.coffee', 'client');
  api.add_files('client/ui-harness/helper-lorem.coffee', 'client');
  api.add_files('client/ui-harness/helpers.coffee', 'client');
  api.add_files('client/ui-harness/log.coffee', 'client');
  api.add_files('client/ui-harness/ui-harness.coffee', 'client');
  ...
  api.add_files('client/internal/devices.coffee', 'client');
